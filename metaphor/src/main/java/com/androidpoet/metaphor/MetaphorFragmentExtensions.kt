...
public fun View.metaphorShowViewWithAnimation(root: CoordinatorLayout) {
    val materialFade = MaterialFadeThrough().apply {
        duration = 150L
    }
...
public fun View.metaphorHideViewWithAnimation(root: CoordinatorLayout) {
    val materialFade = MaterialFadeThrough().apply {
        duration = 84L
    }
    TransitionManager.beginDelayedTransition(root, materialFade)
...
/** gone view extensions*/
public fun View.gone() {
    visibility = View.GONE
}

/** show view extensions*/
...
public fun Fragment.metaphorShowViewWithMaterialFade(root: CoordinatorLayout, view: View) {
...
public fun Fragment.metaphorHideWithMaterialFade(root: CoordinatorLayout, view: View) {
    val materialFade = MaterialFade().apply {
        duration = 550L
    }
    TransitionManager.beginDelayedTransition(root, materialFade)
